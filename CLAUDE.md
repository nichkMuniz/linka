...
| Prescrição de treino individualizada: gerador de rotina sugerida, seleção de exercícios, séries/reps/descanso, técnicas de execução, restrições articulares | `personal-trainer-agent` | `skills/personal-trainer-agent.md` |
