...
| Etapa | Otimização |
|---|---|
| Gravação no app | `RECORDER_BITRATE` no `MediaRecorder` — 2 Mbps de vídeo + 96 kbps de áudio. Sem o teto, o iOS grava 1080p no bitrate máximo (~10 Mbps ≈ 75MB/min) e o flow demora vários segundos para abrir em rede móvel. |
