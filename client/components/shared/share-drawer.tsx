      ...
      <DrawerContent className="max-h-[80vh]">
        ...
        <div className="flex gap-4 px-4 py-4 overflow-x-auto">
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">WhatsApp</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">Instagram</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">Facebook</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">Telegram</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">Mais</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-center text-foreground">Copiar</span>
          </button>
        </div>
