...
import { ImagePlus, PlusSquare, X } from "lucide-react";
            ...
            <form className="grid gap-5" onSubmit={form.handleSubmit(onSubmit)}>
              <div className="grid gap-4 md:grid-cols-[1fr_1fr]">
                <div className="space-y-3">
                  <div className="text-sm font-medium">Mídia (opcional)</div>

                  <label
                    className={cn(
                      "group relative flex aspect-square w-full cursor-pointer items-center justify-center overflow-hidden rounded-2xl border border-dashed border-border/80 bg-muted/30 transition hover:bg-muted/50",
                      imageDataUrl && "border-solid",
                    )}
                  >
                    {imageDataUrl ? (
                      <img
                      ...
                      <div className="flex flex-col items-center gap-2 px-6 text-center">
                        ...
                        <div className="text-sm font-medium">
                          Adicionar foto do treino/refeição
                        </div>
